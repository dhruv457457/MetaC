...
export default function ProfileEdit({ user, onClose, onSave }) {
  ...
  const handleSave = async () => {
    try {
      setLoading(true);
      const res = await axios.put(`https://metac.onrender.com/api/users/${user._id}/profile`, {
        username,
        bio,
        profileImage,
      });
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      setUploading(true);
      const res = await axios.post("https://metac.onrender.com/api/users/upload-avatar", formData, {
